...
The following example declares simple feature switch:
...
If the feature is enabled _(value is "y"), the elements of the `set@y` entry are
...
for acting on disabled features or multiple choices.
...
zlib{c/library}:
    ...
    source@feature/gz=y:  [compress.c, uncompr.c, gzclose.c, gzlib.c,
                           gzread.c, gzwrite.c]
    headers:
        pub:
...
* use [go-magicdict](https://github.com/metux/go-magicdict): provides easy YAML data access with variable interpolation and defaults
